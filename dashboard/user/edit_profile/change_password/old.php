...
<html>
	<head>
		...
		<meta name="description" content="Change Password for Dream Cash">	
	...
	<body>
					...
					<div class="col-xs-10 col-md-8">
						...
						<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
							<div class="fitz-input-group">
								<label class="fitz-label fitz-validate"> Old password: </label>
								<input class="fitz-input" name="password" type="password" required>
							</div>
							<div class="fitz-input-group">
							...
							<div class="fitz-input-group">
								...
								<input class="fitz-input" name="confirmpassword" type="password">
							</div><br>
		...
		<footer class="footer">
		  <div class="container">
			<p class="text-muted">2017 &copy; Copyright Dreamcash.com</p>
		  </div>
		</footer>

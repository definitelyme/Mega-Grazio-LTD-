...
$mail->addReplyTo('replyto@megagrazio.com', 'Mega Grazio LTD');

//Set who the message is to be sent to
$mail->addAddress($email, 'User-Account');
					...
					<body>
						...
						<section class='fitz-container' style='margin-top:20px'>
							...
							<p style='background-color:lightgrey;height:30px;line-height:45px;border-radius:2px' align='center'>
								<a href='http://www.megagrazio.com/activate'> Confirm your email address here </a> before you <a href='http://www.megagrazio.com/login'> Login </a>.
							</p>
...
Confirm your email address here -> http://www.megagrazio.com/activate before you Login here -> http://www.megagrazio.com/login

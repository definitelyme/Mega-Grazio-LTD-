...
if(isset($_POST["REGISTER"]))
{
	...
	{
		$err = "*One or more fields are still required!";
	}
		...
		if($username == 'fitz'){
			...
			if($row['username'] == 'fitz'){
				...
				if($admin == TRUE){
					...
					$err = "You are either an impostor, or there was an error during registration.<br> Please check details";
				}
			}
		}
			...
			if ($mail->send()) {
				...
				$err = "Oops! Activation Email not sent please contact <a href='mailto:omsomega34@gmail.com'> Administrator</a>: ";
			}
		}
	}
